...
export function AuthoritySection() {
  return (
    <section id="instrutor" className="w-full flex justify-center border-b border-border-dark bg-background">
      <div className="max-w-7xl w-full mx-auto flex flex-col lg:flex-row border-x border-border-dark">
